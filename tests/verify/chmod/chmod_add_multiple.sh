...
outputfile=../../outputfiles/chmod/chmod_add_multiple.txt
testfile=../../testfiles/chmod/chmod_add_multiple.txt
...
python3 ../../../src/main.py chmod g+wx my_super_file &> $outputfile
scriptresult=$?
